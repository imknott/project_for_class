                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      ...
                                      final snackBar = SnackBar(
                                        content: Text(
                                          "Would you like to bet on ${_gameModel?[currentIndex].homeTeam?.nickname}",
                                        ),
                                          ...
                                          child: Card(
                                            child: ListTile(
                                              leading: Text(snapshot
                                                  .data[index].conference.rank
                                                  .toString()),
                                              title: Text(snapshot
                                                  .data[index].eastTeam.name
                                                  .toString()),
                                              subtitle: Text(
                                                  "${snapshot.data[index].win.total.toString()} - ${snapshot.data[index].loss.total.toString()}"),
                                              trailing: Text(snapshot
                                                  .data[index].conference.name
                                                  .toString()
                                                  .toUpperCase()),
                                            ),
                                          ),
